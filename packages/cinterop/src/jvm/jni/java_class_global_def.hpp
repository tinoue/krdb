...
private:
    JavaClassGlobalDef(JNIEnv* env)
        ...
        , m_io_realm_kotlin_internal_interop_sync_network_transport(env, "io/github/xilinjia/krdb/internal/interop/sync/NetworkTransport", false)
        , m_io_realm_kotlin_internal_interop_sync_response(env, "io/github/xilinjia/krdb/internal/interop/sync/Response", false)
        ...
        , m_io_realm_kotlin_internal_interop_sync_sync_error(env, "io/github/xilinjia/krdb/internal/interop/sync/SyncError", false)
        , m_io_realm_kotlin_internal_interop_sync_core_compensating_write_info(env, "io/github/xilinjia/krdb/internal/interop/sync/CoreCompensatingWriteInfo", false)
        , m_io_realm_kotlin_internal_interop_sync_app_error(env, "io/github/xilinjia/krdb/internal/interop/sync/AppError", false)
        , m_io_realm_kotlin_internal_interop_log_callback(env, "io/github/xilinjia/krdb/internal/interop/LogCallback", false)
        , m_io_realm_kotlin_internal_interop_sync_error_callback(env, "io/github/xilinjia/krdb/internal/interop/SyncErrorCallback", false)
        , m_io_realm_kotlin_internal_interop_sync_jvm_sync_session_transfer_completion_callback(env, "io/github/xilinjia/krdb/internal/interop/sync/JVMSyncSessionTransferCompletionCallback", false)
        , m_io_realm_kotlin_internal_interop_sync_response_callback_impl(env, "io/github/xilinjia/krdb/internal/interop/sync/ResponseCallbackImpl", false)
        , m_io_realm_kotlin_internal_interop_subscription_set_callback(env, "io/github/xilinjia/krdb/internal/interop/SubscriptionSetCallback", false)
        , m_io_realm_kotlin_internal_interop_sync_before_client_reset_handler(env, "io/github/xilinjia/krdb/internal/interop/SyncBeforeClientResetHandler", false)
        , m_io_realm_kotlin_internal_interop_sync_after_client_reset_handler(env, "io/github/xilinjia/krdb/internal/interop/SyncAfterClientResetHandler", false)
        ...
        , m_io_realm_kotlin_internal_interop_sync_async_open_callback(env, "io/github/xilinjia/krdb/internal/interop/AsyncOpenCallback", false)
        , m_io_realm_kotlin_internal_interop_progress_callback(env, "io/github/xilinjia/krdb/internal/interop/ProgressCallback", false)
        , m_io_realm_kotlin_internal_interop_app_callback(env, "io/github/xilinjia/krdb/internal/interop/AppCallback", false)
        , m_io_realm_kotlin_internal_interop_connection_state_change_callback(env, "io/github/xilinjia/krdb/internal/interop/ConnectionStateChangeCallback", false)
        , m_io_realm_kotlin_internal_interop_sync_thread_observer(env, "io/github/xilinjia/krdb/internal/interop/SyncThreadObserver", false)
        , m_io_realm_kotlin_internal_interop_sync_websocket_transport(env, "io/github/xilinjia/krdb/internal/interop/sync/WebSocketTransport", false)
        , m_io_realm_kotlin_internal_interop_sync_websocket_client(env, "io/github/xilinjia/krdb/internal/interop/sync/WebSocketClient", false)
        ...
        , m_io_realm_kotlin_internal_interop_sync_connection_state(env, "io/github/xilinjia/krdb/internal/interop/sync/CoreConnectionState", false)
